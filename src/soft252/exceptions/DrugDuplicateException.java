...
/**
 * DrugDuplicateException is an exceptions related to the attempt of creating a new drug that already exists in the
 * repository.
 */
public class DrugDuplicateException extends Exception {
    /**
